...
export class WafFirewalls {
    ...
    async deleteWafFirewall(
        ...
        const req = new operations.DeleteWafFirewallRequest({
    ...
    async getWafFirewall(
        ...
        const req = new operations.GetWafFirewallRequest({
            firewallId: firewallId,
            filterServiceVersionNumber: filterServiceVersionNumber,
            include: include,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
    ...
    async updateWafFirewall(
        ...
        const req = new operations.UpdateWafFirewallRequest({
            firewallId: firewallId,
            wafFirewall: wafFirewall,
        });
        const baseURL: string = utils.templateUrl(
