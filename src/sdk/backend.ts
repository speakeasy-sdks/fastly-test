...
export class Backend {
    ...
    async createBackend(
        ...
        const req = new operations.CreateBackendRequest({
            serviceId: serviceId,
            versionId: versionId,
            backend: backend,
        });
    ...
    async deleteBackend(
        ...
        const req = new operations.DeleteBackendRequest({
    ...
    async getBackend(
        ...
        const req = new operations.GetBackendRequest({
            backendName: backendName,
            serviceId: serviceId,
            versionId: versionId,
        });
    ...
    async listBackends(
        ...
        const req = new operations.ListBackendsRequest({
            serviceId: serviceId,
            versionId: versionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async updateBackend(
        ...
        const req = new operations.UpdateBackendRequest({
            backendName: backendName,
            serviceId: serviceId,
            versionId: versionId,
            backend: backend,
