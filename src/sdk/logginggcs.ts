...
export class LoggingGcs {
    ...
    async createLogGcs(
        ...
        const req = new operations.CreateLogGcsRequest({
            serviceId: serviceId,
            versionId: versionId,
        ...
        try {
            [reqBodyHeaders, reqBody] = utils.serializeRequestBody(req, "loggingGcs", "form");
        } catch (e: unknown) {
    ...
    async deleteLogGcs(
        ...
        const req = new operations.DeleteLogGcsRequest({
            ...
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.object = utils.objectToClass(
                        JSON.parse(decodedRes),
                        operations.DeleteLogGcsResponseBody
                    );
                } else {
                    throw new errors.SDKError(
                        "unknown content-type received: " + contentType,
    ...
    async getLogGcs(
        ...
        const req = new operations.GetLogGcsRequest({
            loggingGcsName: loggingGcsName,
            serviceId: serviceId,
            versionId: versionId,
        });
    ...
    async listLogGcs(
        ...
        const req = new operations.ListLogGcsRequest({
            serviceId: serviceId,
            versionId: versionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async updateLogGcs(
        ...
        const req = new operations.UpdateLogGcsRequest({
            loggingGcsName: loggingGcsName,
            serviceId: serviceId,
            versionId: versionId,
            loggingGcs: loggingGcs,
