...
export class GetAclEntrySecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetAclEntryRequest extends SpeakeasyBase {
    /**
...
export class GetAclEntryResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
