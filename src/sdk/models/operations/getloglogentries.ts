...
export class GetLogLogentriesSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetLogLogentriesRequest extends SpeakeasyBase {
    /**
...
export class GetLogLogentriesResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
