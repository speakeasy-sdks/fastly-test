...
export class DeleteLogCloudfilesSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class DeleteLogCloudfilesRequest extends SpeakeasyBase {
    /**
...
export class DeleteLogCloudfilesResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
