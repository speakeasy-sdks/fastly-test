...
export class GetLogDatadogSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetLogDatadogRequest extends SpeakeasyBase {
    /**
...
export class GetLogDatadogResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
