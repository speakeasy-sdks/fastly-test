...
export class DeleteDictionarySecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class DeleteDictionaryRequest extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export class DeleteDictionary200ApplicationJSON extends SpeakeasyBase {
    /**
     * ok
     */
    @SpeakeasyMetadata()
...
export class DeleteDictionaryResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
