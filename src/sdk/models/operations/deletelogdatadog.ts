...
export class DeleteLogDatadogSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class DeleteLogDatadogRequest extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export class DeleteLogDatadog200ApplicationJSON extends SpeakeasyBase {
    /**
     * ok
     */
    @SpeakeasyMetadata()
...
export class DeleteLogDatadogResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
