...
export class DeleteLogDigoceanSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class DeleteLogDigoceanRequest extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export class DeleteLogDigocean200ApplicationJSON extends SpeakeasyBase {
    /**
     * ok
     */
    @SpeakeasyMetadata()
...
export class DeleteLogDigoceanResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
