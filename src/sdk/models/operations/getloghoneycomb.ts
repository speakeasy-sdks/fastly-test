...
export class GetLogHoneycombSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetLogHoneycombRequest extends SpeakeasyBase {
    /**
...
export class GetLogHoneycombResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
