...
export class CloneWafFirewallVersionSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class CloneWafFirewallVersionRequest extends SpeakeasyBase {
    /**
...
export class CloneWafFirewallVersionResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
