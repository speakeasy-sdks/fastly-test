...
export class GetLogSumologicSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetLogSumologicRequest extends SpeakeasyBase {
    /**
...
export class GetLogSumologicResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
