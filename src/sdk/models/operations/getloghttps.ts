...
export class GetLogHttpsSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetLogHttpsRequest extends SpeakeasyBase {
    /**
...
export class GetLogHttpsResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
