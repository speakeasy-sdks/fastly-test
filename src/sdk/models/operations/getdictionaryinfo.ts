...
export class GetDictionaryInfoSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetDictionaryInfoRequest extends SpeakeasyBase {
    /**
...
export class GetDictionaryInfoResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
