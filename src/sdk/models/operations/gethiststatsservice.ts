...
export class GetHistStatsServiceSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetHistStatsServiceRequest extends SpeakeasyBase {
    /**
...
export class GetHistStatsServiceResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
