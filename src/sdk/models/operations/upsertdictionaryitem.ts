...
export class UpsertDictionaryItemSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class UpsertDictionaryItemRequest extends SpeakeasyBase {
    /**
...
export class UpsertDictionaryItemResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
