...
export class GetLogKinesisSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetLogKinesisRequest extends SpeakeasyBase {
    /**
...
export class GetLogKinesisResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
