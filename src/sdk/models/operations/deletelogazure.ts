...
export class DeleteLogAzureSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class DeleteLogAzureRequest extends SpeakeasyBase {
    /**
...
export class DeleteLogAzureResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
