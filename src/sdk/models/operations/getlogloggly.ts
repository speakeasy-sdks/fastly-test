...
export class GetLogLogglySecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class GetLogLogglyRequest extends SpeakeasyBase {
    /**
...
export class GetLogLogglyResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
