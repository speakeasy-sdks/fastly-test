...
export class DeleteServerPoolSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=Fastly-Key" })
    token: string;
}

export class DeleteServerPoolRequest extends SpeakeasyBase {
    /**
     * Name for the Pool.
     */
...
export class DeleteServerPoolResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
