 ...
 *
 */
export enum LoggingDatadogResponseFormatVersion {
    One = 1,
    Two = 2,
}
 ...
 *
 */
export enum LoggingDatadogResponsePlacement {
    None = "none",
    WafDebug = "waf_debug",
 ...
 */
export enum LoggingDatadogResponseRegion {
    Us = "US",
    Eu = "EU",
}
...
export class LoggingDatadogResponse extends SpeakeasyBase {
    ...
    formatVersion?: LoggingDatadogResponseFormatVersion;
    ...
    placement?: LoggingDatadogResponsePlacement;
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "region" })
    region?: LoggingDatadogResponseRegion;
