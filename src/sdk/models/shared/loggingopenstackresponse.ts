 ...
 */
export enum LoggingOpenstackResponseCompressionCodec {
    Zstd = "zstd",
    Snappy = "snappy",
    Gzip = "gzip",
}
 ...
 *
 */
export enum LoggingOpenstackResponseFormatVersion {
    One = 1,
    Two = 2,
}
 ...
 */
export enum LoggingOpenstackResponseMessageType {
    Classic = "classic",
    Loggly = "loggly",
    Logplex = "logplex",
    Blank = "blank",
...
export class LoggingOpenstackResponse extends SpeakeasyBase {
    ...
    compressionCodec?: LoggingOpenstackResponseCompressionCodec;
    ...
    messageType?: LoggingOpenstackResponseMessageType;
