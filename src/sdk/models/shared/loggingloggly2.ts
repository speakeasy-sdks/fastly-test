 ...
 *
 */
export enum LoggingLogglyFormatVersion {
    One = 1,
    Two = 2,
}
...
export class LoggingLoggly2 extends SpeakeasyBase {
    /**
    ...
    formatVersion?: LoggingLogglyFormatVersion;
    ...
    placement?: LoggingLogglyPlacement;
