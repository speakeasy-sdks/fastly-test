 ...
 *
 */
export enum LoggingSumologicResponseFormatVersion {
    One = 1,
    Two = 2,
}
 ...
 *
 */
export enum LoggingSumologicResponsePlacement {
    None = "none",
    WafDebug = "waf_debug",
}
...
export class LoggingSumologicResponse extends SpeakeasyBase {
    ...
    formatVersion?: LoggingSumologicResponseFormatVersion;
    ...
    placement?: LoggingSumologicResponsePlacement;
