 ...
 *
 */
export enum LoggingLogentriesResponseFormatVersion {
    One = 1,
    Two = 2,
}
 ...
 */
export enum LoggingLogentriesResponseRegion {
    Us = "US",
    Us2 = "US-2",
    Us3 = "US-3",
    Eu = "EU",
...
export class LoggingLogentriesResponse extends SpeakeasyBase {
    ...
    formatVersion?: LoggingLogentriesResponseFormatVersion;
    ...
    placement?: LoggingLogentriesResponsePlacement;
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "region" })
    region?: LoggingLogentriesResponseRegion;
