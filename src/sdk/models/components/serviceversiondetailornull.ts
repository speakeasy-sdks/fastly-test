 ...
 */
export class ServiceVersionDetailOrNullSettings extends SpeakeasyBase {
    /**
...
export class ServiceVersionDetailOrNullWordpress extends SpeakeasyBase {}

export class ServiceVersionDetailOrNull extends SpeakeasyBase {
    /**
    ...
    @Type(() => ServiceVersionDetailOrNullSettings)
    settings?: ServiceVersionDetailOrNullSettings;
     ...
     */
    @SpeakeasyMetadata({ elemType: ServiceVersionDetailOrNullWordpress })
    @Expose({ name: "wordpress" })
    @Type(() => ServiceVersionDetailOrNullWordpress)
    wordpress?: ServiceVersionDetailOrNullWordpress[];
}
