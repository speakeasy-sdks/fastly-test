 ...
 */
export class RealtimeEntry extends SpeakeasyBase {
    /**
     * Aggregates [measurements](#measurements-data-model) across all Fastly POPs.
     */
    @SpeakeasyMetadata()
     ...
     */
    @SpeakeasyMetadata({ elemType: RealtimeMeasurements })
    @Expose({ name: "datacenter" })
    @Transform(
        ({ value }) => {
            const obj: Record<string, RealtimeMeasurements> = {};
            for (const key in value) {
                obj[key] = objectToClass(value[key], RealtimeMeasurements);
            }
            return obj;
        },
        { toClassOnly: true }
    )
    datacenter?: Record<string, RealtimeMeasurements>;
