...
sdk.loggingSyslog.createLogSyslog({
  loggingSyslog2: {
    ...
    hostname: "kooky-propaganda.name",
    ipv4: "83.183.193.6",
    ...
    tlsCaCert: "adipisci",
    tlsClientCert: "cumque",
    tlsClientKey: "consequuntur",
    tlsHostname: "consequatur",
    token: "minus",
...
sdk.loggingSyslog.updateLogSyslog({
  loggingSyslog2: {
    ...
    format: "%h %l %u %t "%r" %&gt;s %b",
    formatVersion: LoggingSyslogFormatVersion.Two,
    hostname: "emotional-infancy.name",
    ipv4: "151.244.219.142",
    messageType: LoggingMessageType.Classic,
    name: "test-log-endpoint",
    placement: LoggingSyslogPlacement.WafDebug,
    port: 97468,
