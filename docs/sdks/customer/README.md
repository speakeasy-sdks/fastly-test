...
**Promise<[operations.GetLoggedInCustomerResponse](../../sdk/models/operations/getloggedincustomerresponse.md)>**
### Errors
...
```typescript
import { Fastly } from "Fastly";
import { BillingNetworkType } from "Fastly/dist/sdk/models/components";
