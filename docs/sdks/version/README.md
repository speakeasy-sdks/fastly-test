...
import { ActivateServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const versionId: number = 1;
  ...
  const res = await sdk.version.activateServiceVersion(serviceId, versionId);
...
```typescript
import { Fastly } from "Fastly";
import { CloneServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const versionId: number = 1;
  ...
  const res = await sdk.version.cloneServiceVersion(serviceId, versionId);
...
```typescript
import { Fastly } from "Fastly";
import { CreateServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const serviceId: string = "SU1Z0isxPaozGVKXdv0eY";
  ...
  const res = await sdk.version.createServiceVersion(serviceId);
...
```typescript
import { Fastly } from "Fastly";
import { DeactivateServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const versionId: number = 1;
  ...
  const res = await sdk.version.deactivateServiceVersion(serviceId, versionId);
...
```typescript
import { Fastly } from "Fastly";
import { GetServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const versionId: number = 1;
  ...
  const res = await sdk.version.getServiceVersion(serviceId, versionId);
...
```typescript
import { Fastly } from "Fastly";
import { ListServiceVersionsRequest } from "Fastly/dist/sdk/models/operations";
...
const serviceId: string = "SU1Z0isxPaozGVKXdv0eY";
  ...
  const res = await sdk.version.listServiceVersions(serviceId);
...
```typescript
import { Fastly } from "Fastly";
import { LockServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const versionId: number = 1;
  ...
  const res = await sdk.version.lockServiceVersion(serviceId, versionId);
...
```typescript
import { Fastly } from "Fastly";
import { VersionInput } from "Fastly/dist/sdk/models/components";
import { UpdateServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const version: VersionInput = {
  ...
  const res = await sdk.version.updateServiceVersion(serviceId, versionId, version);
...
```typescript
import { Fastly } from "Fastly";
import { ValidateServiceVersionRequest } from "Fastly/dist/sdk/models/operations";
...
const versionId: number = 1;
  ...
  const res = await sdk.version.validateServiceVersion(serviceId, versionId);
